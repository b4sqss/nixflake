...
(def-doom-theme doom-gruvbox
  ...
  ;; name        gui       256       16
  ((bg
    (cond ((equal doom-gruvbox-dark-variant "hard") '("#3c474d" "#3c474d" nil))   ; bg0_h
          ((equal doom-gruvbox-dark-variant "soft") '("#323d43" "#323d43" nil))   ; bg0_s
          (t                                        '("#323d43" "#323d43" nil)))) ; bg0
   (bg-alt
    (cond ((equal doom-gruvbox-dark-variant "hard") '("#3c474d" "#3c474d" nil))     ; (self-defined)
          ((equal doom-gruvbox-dark-variant "soft") '("#3c474d" "#3c474d" nil))   ; bg0
          (t                                        '("#3c474d" "#3c474d" nil)))) ; bg_h
   (bg-alt2    '("#465258" "#465258" "brown"      )) ; bg2 (for region, selection etc.)

   (base0      '("#323d43" "black"   "black"      )) ; (self-defined)
   (base1      '("#323d43" "#3c474d" "brightblack")) ; bg0_h
   (base2      '("#323d43" "#465258" "brightblack")) ; bg0
   (base3      '("#3c474d" "#505a60" "brightblack")) ; bg1
   (base4      '("#3d5665" "#576268" "brightblack")) ; bg3
   (base5      '("#708089" "#5f6d67" "brightblack")) ; bg4
   (base6      '("#7a8478" "#7a8478" "brightblack")) ; gray
   (base7      '("#efead4" "#efead4" "brightblack")) ; fg2
   (base8      '("#dcd8c4" "#dcd8c4" "brightwhite")) ; fg0
   (fg         '("#d3c6aa" "#d3c6aa" "brightwhite")) ; fg/fg1
   (fg-alt     '("#efead4" "#efead4" "brightwhite")) ; fg2

   ;; Standardized official colours from gruvbox
   (grey        '("#7a8478" "#909090" "brightblack"))   ; gray
   (red         '("#da6362" "#e74c3c" "red"))           ; bright-red
   (magenta     '("#e66868" "#cc241d" "magenta"))       ; red
   (violet      '("#d699b6" "#d3869b" "brightmagenta")) ; bright-purple
   (orange      '("#d77f48" "#fd971f" "orange"))        ; bright-orange
   (yellow      '("#dbbc7f" "#fabd2f" "yellow"))        ; bright-yellow
   (dark-yellow '("#dbbc7f" "#fabd2f" "yellow"))        ; yellow
   (teal        '("#9da9a0" "#8ec07c" "green"))         ; bright-aqua
   (green       '("#a7c080" "#b8bb26" "green"))         ; bright-green
   (dark-green  '("#a7c080" "#98971a" "green"))         ; green
   (blue        '("#7fbbb3" "#83a598" "brightblue"))    ; bright-blue
   (dark-blue   '("#7fbbb3" "#458588" "blue"))          ; blue
   (cyan        '("#83c092" "#8ec07c" "brightcyan"))    ; bright-aqua
   (dark-cyan   '("#83c092" "#689d6a" "cyan"))          ; aqua
