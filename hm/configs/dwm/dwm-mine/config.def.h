...
/* //My commands */
static const char *printcmd[]  = { "scrot", "-e", "'mv $f ~/Pics/screenshots'", NULL };
...
static const char *emacsclientcmd[]  = { "emacsclient", "-cn", NULL };
static const char *diredcmd[]  = { "emacsclient", "-c", "-a", "'emacs'", "--eval", "'(dired nil)", NULL };

static const char *firefoxcmd[] = {"firefox", NULL};
static const char *bravecmd[] = {"brave", NULL};

static const char *recordcmd[] = { "dunstify", "-u", "CRIT", "gravando", "-t", "800", "&&", "ffmpeg", "-f", "x11grab", "-s", "1920x1080", "-i", ":1" "$HOME/Docs/videos/$(date +'%d_%m_%Y_%I_%M').mp4", NULL};
static const char *stoprecordcmd[] = {"pkill", "ffmpeg", "&&", "dunstify", "-u", "LOW", "screencast saved", NULL};
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_F11,      spawn,          {.v = brightnessDowncmd } },
	{ MODKEY,                       XK_F12,      spawn,          {.v = brightnessUpcmd } },

	{ MODKEY,                       XK_s,      spawn,          {.v = recordcmd } },
	{ MODKEY|ShiftMask,             XK_s,      spawn,          {.v = stoprecordcmd } },

	{ MODKEY|ShiftMask,             XK_a,      spawn,          {.v = emacscmd } },
	{ MODKEY,                       XK_a,      spawn,          {.v = emacsclientcmd} },
	{ MODKEY,                       XK_d,      spawn,          {.v = diredcmd} },
